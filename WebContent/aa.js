...
AjaxAnywhere.prototype.callback = function() {
    ...
    if (this.req.readyState == 4) {
        ...
        if (this.req.status == 200) {
            ...
            if (this.req.getResponseHeader('content-type').toLowerCase().substring(0, 8) != 'text/html' && false)
                alert("AjaxAnywhere error : bah oui, content-type in not text/html : [" + this.req.getResponseHeader('content-type') + "]");
